...
Route::middleware('auth:sanctum')->patch('/events.update', [EventController::class, 'update']);
Route::middleware('auth:sanctum')->delete('/events.delete', [EventController::class, 'delete']);
